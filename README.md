...
```s
# Run in the Terminal
git clone https://github.com/PutluruAravindaReddy/Little_lemon.git folder
...
This demo project is solely done by me, Jayanta Samaddar. You can contact me on **[GitHub](https://github.com/PutluruAravindaReddy/)** for interesting projects to work on.
